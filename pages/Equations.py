...
with cc:
    ...
    st.latex(r"F_b + \textcolor{#deb887}{F_d} = \textcolor{#bc8f8f}{F_c} + \textcolor{#cd5c5c}{F_f} + {\color{teal}F_{dis}}")
    ...
    st.latex( r"\textcolor{#cd5c5c}{F_f} = {\color{purple}F_{f,b}} + \textcolor{#deb887}{F_d} ")
    ...
    st.latex(r"X_b F_b + \textcolor{#deb887}{X_d F_d} = \textcolor{#bc8f8f}{X_c F_c} + \textcolor{#cd5c5c}{X_f F_f} + {\color{teal}X_{dis} F_{dis}}")
    ...
    st.latex(r"{\color{teal}F_{dis}} = (\textcolor{#bc8f8f}{X_{c} F_{c}} + \textcolor{#cd5c5c}{ X_{f} F_{f}} - X_{b} F_{b})/\textcolor{#deb887}{X_{d}}  - \textcolor{#cd5c5c}{F_{f}} - \textcolor{#bc8f8f}{F_{c}} + F_{b} ")
